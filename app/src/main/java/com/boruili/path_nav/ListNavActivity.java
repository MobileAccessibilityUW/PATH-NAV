...
public class ListNavActivity extends Activity implements AdapterView.OnItemClickListener{
    EditText editText;
    Button addButton;
    ListView listView;
...
//        File file = new File(this.getFilesDir(), "names");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Toast.makeText(ListNavActivity.this, parent.getItemAtPosition(position).toString(), Toast.LENGTH_LONG)
                .show();
...
//        ps.println(parent.getItemAtPosition(position).toString());
